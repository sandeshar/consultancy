                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <a href="https://wa.me/9779867903342" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 p-3 bg-green-50 hover:bg-green-500 text-gray-700 hover:text-white rounded-lg transition-all duration-300 group">
                            ...
                            <div className="relative z-10">
                                ...
                                <form action={handleForm} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input name="phone" type="tel" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors" placeholder="078-595444" required />
                                    </div>
