  ...
  return (
    <div className={`bg-gray-900 text-white transition-all duration-300 ease-in-out ${
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        <button
          onClick={() => router.push('/')}
          className={`w-full flex items-center px-3 py-2 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white transition-colors ${
        ...
        <button
          onClick={onLogout}
          className={`w-full flex items-center px-3 py-2 rounded-md text-red-400 hover:bg-red-600 hover:text-white transition-colors ${
            isCollapsed ? 'justify-center' : ''
          }`}
